...
{% footnotes %}
  {% fnbody %}
    Larry Carson, "8 Losing Gtv Jobs Look Back as They Also Look Forward," _The Sun (Baltimore)_, January 23, 2008.
  {% endfnbody %}
  {% fnbody %}
    Montgomery County, Maryland, "County Cable Montgomery": http://www.montgomerycountymd.gov/apps/CABLE/site/index.cfm
  {% endfnbody %}
{% endfootnotes %}
